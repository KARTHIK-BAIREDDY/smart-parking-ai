...
export default function MyVehiclesPage() {
  ...
  const handleDelete = async () => {
    ...
    setDeleting(true);
    try {
      const res = await fetch(`/api/vehicles?id=${vehicleToDelete.id}`, {
        method: "DELETE",
      });
      if (res.ok) {
        setSuccess(`Vehicle ${vehicleToDelete.vehicleNumber} removed.`);
                    ...
                    >
                      ...
                      <div className="text-right flex flex-col items-end gap-2">
                        ...
                        <button
                          ...
                          className="mt-2 text-xs font-medium text-rose-400 hover:text-rose-300 flex items-center gap-1 bg-rose-500/10 hover:bg-rose-500/20 px-2 py-1 rounded transition-colors"
                        >
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
            ...
            >
              ...
              <p className="text-gray-300 mb-6 text-sm leading-relaxed">
                Are you sure you want to remove <span className="font-bold text-white tracking-wider">{vehicleToDelete.vehicleNumber}</span>? 
              ...
              <div className="flex justify-end gap-3">
                ...
                <button
                  ...
                  disabled={deleting}
                  className="px-4 py-2 rounded-xl text-sm font-medium text-white bg-rose-500 hover:bg-rose-600 transition-colors flex items-center gap-2"
                >
